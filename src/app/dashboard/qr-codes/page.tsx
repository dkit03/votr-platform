...
export default function QrCodesPage() {
    ...
    const loadCodes = async () => {
        ...
        try {
            ...
            const res = await fetch(`/api/qr-codes?band_id=${bandId}&page=${page}&filter=${filter}`);
    ...
    const handleGenerate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch('/api/qr-codes', {
                ...
                body: JSON.stringify({ bandId, count: genCount, prefix: genPrefix }),
            });
            const data = await res.json();
            if (res.ok) {
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                maxLength={6}
                                className="w-full px-4 py-3 rounded-xl bg-votr-dark border border-votr-dark-border text-white font-mono focus:outline-none focus:border-votr-gold transition-colors"
                            />
